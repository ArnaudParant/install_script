...
# 120 "odoc_text_parser.mly"
           ( Some RK_module_type )
# 472 "odoc_text_parser.ml"
               : 'ele_ref_kind))
; (fun __caml_parser_env ->
    Obj.repr(
# 121 "odoc_text_parser.mly"
          ( Some RK_class )
# 478 "odoc_text_parser.ml"
               : 'ele_ref_kind))
; (fun __caml_parser_env ->
    Obj.repr(
# 122 "odoc_text_parser.mly"
          ( Some RK_class_type )
# 484 "odoc_text_parser.ml"
               : 'ele_ref_kind))
; (fun __caml_parser_env ->
    Obj.repr(
# 123 "odoc_text_parser.mly"
          ( Some RK_attribute )
# 490 "odoc_text_parser.ml"
               : 'ele_ref_kind))
; (fun __caml_parser_env ->
    Obj.repr(
...
# 125 "odoc_text_parser.mly"
          ( Some (RK_section []))
# 502 "odoc_text_parser.ml"
               : 'ele_ref_kind))
; (fun __caml_parser_env ->
    Obj.repr(
# 126 "odoc_text_parser.mly"
           ( Some RK_recfield )
# 508 "odoc_text_parser.ml"
               : 'ele_ref_kind))
; (fun __caml_parser_env ->
    Obj.repr(
# 127 "odoc_text_parser.mly"
            ( Some RK_const )
# 514 "odoc_text_parser.ml"
               : 'ele_ref_kind))
; (fun __caml_parser_env ->
